    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('blocked_user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='blocker', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('user', 'blocked_user'), name='unique_blocker'),
        ),
        migrations.AddConstraint(
            model_name='userblocked',
            constraint=models.CheckConstraint(check=models.Q(('user', django.db.models.expressions.F('blocked_user')), _negated=True), name="users can't block them selves"),
        ),
    ]
